        ...
        <div className="profile-info">
          ...
          <div className="profile-details">
            ...
            <div className="profile-actions">
              <button className="primary-button" onClick={() => setIsPostModalOpen(true)}>POST</button>  {/*this is where the user starts creating the post It opens a model file to create a post*/}
